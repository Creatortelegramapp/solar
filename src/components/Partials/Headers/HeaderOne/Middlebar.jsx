                ...
                {type === 3 ? (
                    ...
                    <Link to="/">
                      <img
                          width="152"
                          height="36"
                          src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/logo.svg`}
                          alt="logo"
                      />
                    </Link>
                )}
              ...
              <div className="flex space-x-6 items-center">
                <div className="favorite relative">
                  <Link to="/wishlist" className="relative">
                    <ThinLove />
                    {wishlistCount > 0 && (
                        <span className="w-[18px] h-[18px] rounded-full bg-[#00bfb3] absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px] text-qblack">
                      {wishlistCount}
                    </span>
                    )}
                  </Link>
