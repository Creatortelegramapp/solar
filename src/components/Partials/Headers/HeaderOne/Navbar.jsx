...
export default function Navbar() {
  ...
  return (
      <div className="nav-widget-wrapper w-full h-[60px] relative z-30 bg-[#00bfb3]">
                        ...
                        <Link
                            ...
                            className={`pb-2 transition duration-300 ${
                                location.pathname === item.path
                                    ? "text-black-500 font-bold border-b-2 border-black-500"
            ...
            <div className="flex space-x-4 items-center">
              <Link to="/wishlist" className="relative">
                ...
                {wishlistCountMobile > 0 && (
                    <span
                        className="w-[18px] h-[18px] rounded-full bg-white absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px] text-qblack">
                          {wishlistCountMobile}
                        </span>
                )}
              </Link>
